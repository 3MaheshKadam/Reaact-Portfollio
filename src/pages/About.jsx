          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-base text-center text-gray-700 dark:text-gray-300">
                  Offering expert guidance on web technologies, project
                  management, and best practices in development, as well as
              ...
              >
                ...
                <p className="text-base text-center text-gray-700 dark:text-gray-300">
                  Ensuring your applications run smoothly with ongoing
                  maintenance and deploying new features or updates as needed.
                </p>
              </motion.div>
            </div>
          </motion.div>
